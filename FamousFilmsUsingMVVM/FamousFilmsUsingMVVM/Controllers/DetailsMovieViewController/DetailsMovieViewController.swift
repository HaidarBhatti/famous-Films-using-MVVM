...
class DetailsMovieViewController: UIViewController {
    ...
    func openDetails(personId id: Int){
        let viewModel = DetailsPersonViewModel(personID: id)
        let vc = DetailsPersonViewController(viewModel: viewModel)
